...
//------------------------------- BUTTON HANDLER METHODS --------------------------------//
  ...
  static handleTaskButton(e) {
    ...
    if (e.target.classList.contains('fa-pen-to-square')) {
      ...
      const taskDescription = _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList().getProject(taskProjectTitle).getTask(taskTitle).getDescription();
      const taskPriority = _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList().getProject(taskProjectTitle).getTask(taskTitle).getPriority();
      const taskDueDate = _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList().getProject(taskProjectTitle).getTask(taskTitle).getDueDate();
    ...
    if (e.target.getAttribute('id') === 'task-complete-checkbox') {
      ...
      _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].updateTaskChecked(projectTitle, taskTitle, taskChecked);
    }
...
//------------------------------------ TASK METHODS -------------------------------------//
  ...
  static addTask() {
    ...
    if (_Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList().getProject(taskProject).checkTask(taskTitle)) {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].addTask(taskProject, new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](taskTitle, taskDescription, taskDueDate, taskPriority, taskChecked));
  ...
  static deleteTask(taskTitle) {
    const taskProjectTitle = document.getElementById('project-title').textContent;
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].deleteTask(taskProjectTitle, taskTitle);
  ...
  static createTask(taskTitle, taskDueDate, taskPriority, taskChecked) {
    ...
    taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskDueDate), 'dd/MM/yyyy');
  ...
  static updateTask() {
    ...
    if (oldTaskTitle !== newTaskTitle) {
      if (_Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList().getProject(taskProject).checkTask(newTaskTitle)) {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].updateTaskDescription(taskProject, oldTaskTitle, newTaskDescription);
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].updateTaskDueDate(taskProject, oldTaskTitle, newTaskDueDate);
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].updateTaskPriority(taskProject, oldTaskTitle, newTaskPriority);
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].updateTaskTitle(taskProject, oldTaskTitle, newTaskTitle);
...
//---------------------------------- PROJECT METHODS ------------------------------------//
  ...
  static addProject() {
    ...
    if (_Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList().checkProject(projectTitle)) {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].addProject(new _Project__WEBPACK_IMPORTED_MODULE_1__["default"](projectTitle));
  ...
  static deleteProject(projectTitle, projectButton) {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].deleteProject(projectTitle);
...
document.addEventListener('DOMContentLoaded', _Interface__WEBPACK_IMPORTED_MODULE_0__["default"].initHomepage);
