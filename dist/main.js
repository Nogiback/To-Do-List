...
class Interface {
  ...
  static handleTaskButton(e) {
    ...
    if (e.target.classList.contains("fa-pen-to-square")) {
      ...
      const taskDescription = _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList()
        .getProject(taskProjectTitle)
        .getTask(taskTitle)
        .getDescription();
      const taskPriority = _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList()
        .getProject(taskProjectTitle)
        .getTask(taskTitle)
        .getPriority();
      const taskDueDate = _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList()
        .getProject(taskProjectTitle)
        .getTask(taskTitle)
        .getDueDate();
  ...
  static createTask(taskTitle, taskDueDate, taskPriority, taskChecked) {
    ...
    const formattedTaskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskDueDate), "dd/MM/yyyy");
  ...
  static updateTask() {
    ...
    if (oldTaskTitle !== newTaskTitle) {
      if (
        _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getToDoList().getProject(taskProject).checkTask(newTaskTitle)
      ) {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].updateTaskDescription(
      taskProject,
      oldTaskTitle,
      newTaskDescription,
    );
