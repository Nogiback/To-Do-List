...
//------------------------------------ TASK METHODS -------------------------------------//
  ...
  static addTask() {
    ...
    const taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskDateField.value), 'dd/MM/yyyy');
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].addTask(taskProject, new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](taskTitle, taskDescription, taskDueDate, taskPriority));
...
console.log(_Storage__WEBPACK_IMPORTED_MODULE_1__["default"].getToDoList());
