  ...
  \**************************/
      /***/ (
        ...
        /* harmony import */ var _Project__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./Project */ './src/Project.js');
        /* harmony import */ var _Storage__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./Storage */ './src/Storage.js');
        ...
        class Interface {
          ...
          static initHomepage() {
            ...
            Interface.openProject(
              'Inbox',
              document.getElementById('inbox-btn'),
            );
          }
          ...
          static initModalButtons() {
            ...
            const closeAddTaskButton = document.getElementById(
            ...
            const closeTaskInfoButton = document.getElementById(
              'close-task-info-btn',
            );
            ...
            closeAddTaskButton.addEventListener(
              'click',
              Interface.closeAddTaskModal,
            );
            addProjectButton.addEventListener(
              'click',
              Interface.openAddProjectModal,
            );
          ...
          static initProjectButtons() {
            ...
            const userProjectButtons =
              document.querySelectorAll('.user-project-btn');
          ...
          static openAddProjectModal() {
            const addProjectModal = document.getElementById('project-modal');
            const projectTitleField = document.getElementById(
              'project-title-input',
            );
            const overlay = document.getElementById('overlay');
          ...
          static openEditTaskModal(
            ...
            const editTaskTitleField = document.getElementById(
              'new-task-title-input',
            );
            const editTaskDescField = document.getElementById(
              'new-task-description',
            );
            const editTaskPriorityField =
          ...
          static handleTaskButton(e) {
            ...
            if (e.target.classList.contains('fa-pen-to-square')) {
              ...
              const taskDescription = _Storage__WEBPACK_IMPORTED_MODULE_2__[
                'default'
              ]
                .getToDoList()
                ...
                .getTask(taskTitle)
                .getDescription();
              const taskPriority = _Storage__WEBPACK_IMPORTED_MODULE_2__[
                'default'
              ]
                .getToDoList()
                .getProject(taskProjectTitle)
                .getTask(taskTitle)
                .getPriority();
              const taskDueDate = _Storage__WEBPACK_IMPORTED_MODULE_2__[
                'default'
              ]
                .getToDoList()
                .getProject(taskProjectTitle)
            ...
            if (e.target.getAttribute('id') === 'task-complete-checkbox') {
              ...
              _Storage__WEBPACK_IMPORTED_MODULE_2__[
                'default'
              ].updateTaskChecked(projectTitle, taskTitle, taskChecked);
            }
          }
          ...
          static addTask() {
            ...
            Interface.closeAddTaskModal();
            _Storage__WEBPACK_IMPORTED_MODULE_2__['default'].addTask(
              taskProject,
          ...
          static deleteTask(taskTitle) {
            const taskProjectTitle =
              document.getElementById('project-title').textContent;
            _Storage__WEBPACK_IMPORTED_MODULE_2__['default'].deleteTask(
              taskProjectTitle,
              taskTitle,
            );
          ...
          static openTask(taskTitle) {
            ...
            const taskPriorityInfo =
              document.getElementById('task-info-priority');
            const taskDueDateInfo =
              document.getElementById('task-info-due-date');
            const taskProjectInfo =
              document.getElementById('task-info-project');
            const overlay = document.getElementById('overlay');
            ...
            const taskPriority = _Storage__WEBPACK_IMPORTED_MODULE_2__[
              ...
              .getTask(taskTitle)
              .getPriority();
            const taskDueDate = _Storage__WEBPACK_IMPORTED_MODULE_2__['default']
              .getToDoList()
              .getProject(taskProjectTitle)
              .getTask(taskTitle)
              .getDueDate();
          ...
          static updateTask() {
            ...
            _Storage__WEBPACK_IMPORTED_MODULE_2__['default'].updateTaskDueDate(
              taskProject,
              oldTaskTitle,
              newTaskDueDate,
            );
            _Storage__WEBPACK_IMPORTED_MODULE_2__['default'].updateTaskPriority(
              taskProject,
              oldTaskTitle,
              newTaskPriority,
            );
            _Storage__WEBPACK_IMPORTED_MODULE_2__['default'].updateTaskTitle(
              taskProject,
              oldTaskTitle,
              newTaskTitle,
            );
          ...
          static addProject() {
            ...
            Interface.closeAddProjectModal();
            _Storage__WEBPACK_IMPORTED_MODULE_2__['default'].addProject(
          ...
          static deleteProject(projectTitle, projectButton) {
            ...
            _Storage__WEBPACK_IMPORTED_MODULE_2__['default'].deleteProject(
              projectTitle,
            );
  ...
  \************************/
      /***/ (
        ...
        /* harmony import */ var _Task__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./Task */ './src/Task.js');
        /* harmony import */ var _ToDoList__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./ToDoList */ './src/ToDoList.js');
      ...
      /***/ (
        ...
        class ToDoList {
          constructor() {
            this.projects = [];
            this.projects.push(
              new _Project__WEBPACK_IMPORTED_MODULE_0__['default']('Inbox'),
            );
          }
          ...
          addProject(newProject) {
            if (
              this.projects.find(
                (project) => project.getTitle() === newProject.title,
              )
            ) {
              return;
            }
